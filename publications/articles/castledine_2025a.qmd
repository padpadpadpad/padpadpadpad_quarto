...
11 of the significant differences  being accounted for _Stenotrophomonas_, which had generally lower values for relative invader growth rate with co-invaders present. [@cr-fig3]{pan-to="30%,-30%"}

Of the other significant differences 9 were accounted from _Ochrobactrum_, 4 by _Achromobacter_, and 2 each for _Pseudomonas_ and _Variovorax._ @cr-fig3
